...
- 역할: Team Leader, 프로젝트 관리, 데이터 분석 및 시각화, 데이터 모델링 및 데이터 파이프라인 구축, 데이터 플랫폼 구축 및 운영, Backend 개발, Frontend 개발
...
- 고용 형태: 정규직
- 팀/직책: DevOps팀 / 팀원
- 역할: 데브옵스 서비스 개발 및 운영, 데이터 모델링, Backend 개발, Frontend 개발
...
- 팀/직책: 서비스 개발팀 / 팀원
- 역할: 데브옵스 서비스 개발 및 운영, 프로젝트 수행, Backend 개발, Frontend 개발
...
- 고용 형태: 정규직
- 팀/직급: 개발팀 / 과장
- 역할: Project Tech Lead, 데이터 모델링, Backend 개발, Frontend 개발
