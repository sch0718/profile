...
개발자로 일하기 시작한 이후 재미있는 일을 하다 보니 의도하지 않았지만 다양한 분야에서 다양한 업무 경험을 하게 되었습니다.
...
- 역할: Project Tech Lead(프로젝트 관리 및 업무 협의, BE/FE 개발 가이드 및 코드 리뷰), Architecture 설계, DB 설계, 컨텐츠 기획
...
- 기간: 2022.09 ~ 2023.03
- 개요: 요기요 App내 주문 전/후 배달 예상 시간을 예측하기 위한 ML Model을 서빙하고, 지속적인 Model의 예측 정확도를 유지하기 위한 지속적 학습(Continuous Training) 환경을 제공, 가게별 배달 시간 설정 및 제공 방식을 관리하는 시스템 개발
- 역할: Project Tech Lead(프로젝트 관리 및 업무 협의, FE 개발 가이드 및 코드 리뷰), Architecture 설계, DB 설계, BE 개발, ML 모델 서빙을 위한 CI/CD/CT 파이프라인 구축 참여, 성능 모니터링 및 개선
- 개발 환경: GCP, k8s(GKE), Container, Linux
- 개발 언어: python, React, typescript, CSS(LESS), shell script
...
- 역할: MLOps Platform Architecture 설계 및 CI/CD/CT 파이프라인 구축 참여
- 개발 환경: GCP, k8s(GKE), Container, Linux
- 개발 언어: python, shell script
- Data Platform/DBMS: BigQuery, PostgreSQL, Kafka(Confluent Cloud), Redis
- Framework/Tool: BentoML, Helm, skaffold, Github, Github Action, Docker, Airflow, Jupyter Notebook
- 직무 경험 및 성과: Data Scientist들의 업무 효율 증대를 위한 Platform 구축 경험, 바로 배달 시간 예측 모델 실시간 서빙 서비스 프로젝트로 이어져 프로젝트 수행 기간을 단축함

### 요기요 데이터 시각화 서비스 고도화
- 기간: 2020.11 ~ 2022.08
- 개요: 요기요 App 내 사용자 주문 시점의 가게 랭킹 시뮬레이션 기능 개발, 고객의 리뷰 내용을 ML Model로 분석하여 어뷰징 및 욕설 감지, 리뷰 내 맛/식감 분류 및 분석 기능 개발
...
- 역할: Architecture 설계, GKE(GCP/k8s) 환경에 인프라 구성 및 CI/CD 프로세스 확립 및 파이프라인 개발, BE/FE 개발
- 개발 환경: GCP, k8s(GKE), Container, Linux
- 개발 언어: python, React, typescript, CSS(LESS), shell script
- Data Platform/DBMS: BigQuery, PostgreSQL, Elasticsearch, Redis
...
- 역할: Micro Service Architecture -> Monolithic Architecture 설계 변경 및 환경 구축 참여, DB 설계, BE/FE 개발, 솔루션 커스터마이즈
...
- 직무 경험 및 성과: DevOps 솔루션 Customize 및 환경 구축 경험

### DevOps 서비스 개발
- 기간: 2018.10 ~ 2019.10
- 개요: Project Management Service의 개발 티켓으로부터 간단한 설정 및 결재 프로세스를 통해 개발/운영 환경 Provisioning 및 CI/CD 파리프라인을 template 기반으로 소유한 Cloud 환경에 빠르고 쉽게 배포할 수 있는 기능을 제공
- 역할: Architecture 설계, DB 설계, BE/FE 개발, open source 솔루션 활용 및 커스터마이즈
- 개발 환경: AWS(Fargate), Container, Linux, Embedded Tomcat
- 개발 언어: JAVA, Vue, javascript, CSS, shell script
- Data Platform/DBMS: MariaDB, Redis, RabbitMQ
- Framework/Tool: Spring Cloud, JPA, MyBatis, Concourse CI, Maven, Nexus, SonarQube, GitLab, Docker
...
- 직무 경험 및 성과: 데브옵스 엔지니어들과의 협업 및 서비스 개발 경험, 클라우드 및 컨테이너 환경에서 개발 경험
